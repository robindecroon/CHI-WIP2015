        ...
        removeData: function (a, b, c) {
            if (!!f.acceptData(a)) {
                ...
                if (b) {
                    d = c ? j[k] : j[k].data;
                    if (d) {
                        f.isArray(b) ? b = b : b in d ? b = [b] : (b = f.camelCase(b), b
                    in
                        d ? b = [b] : b = b.split(" ")
                    )
                        ;
            ...
            return {
                send: function (e, g) {
                    ...
                    h.send(c.hasContent && c.data || null), d = function (a, e) {
                        ...
                        m && g(j, k, m, l)
                    }, !c.async || h.readyState === 4 ? d() : (i = ++ci, ch
                    &&
                    (cj || (cj = {}, f(a).unload(ch)), cj[i] = d), h.onreadystatechange = d
                    )
                }, abort: function () {
                    d && d(0, 1)
                }
    ...
    f.fn.extend({
        show: function (a, b, c) {
            ...
            function g() {
                ...
                for (i in a)j = new f.fx(this, b, i), h = a[i], cp.test(h) ? (o = f._data(this, "toggle" + i) || (h === "toggle" ? d ? "show" : "hide" : 0), o? (f._data(this, "toggle" + i, o === "show" ? "hide" : "show"), j[o]()) : j[h]()
            ):
