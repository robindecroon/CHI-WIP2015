d3 = function () {
    ...
    function it(n, t, e) {
        ...
        return (u = Va.get(n)) ? t(u.r, u.g, u.b) : (null != n && n.charAt(0) === "#" && (n.length === 4 ? (a = n.charAt(1), a+= a, o = n.charAt(2), o += o, c = n.charAt(3), c += c)
    :
        n.length === 7 && (a = n.substring(1, 3), o = n.substring(3, 5), c = n.substring(5, 7)), a = parseInt(a, 16), o = parseInt(o, 16), c = parseInt(c, 16)
    ),
        t(a, o, c)
    )
    }
    ...
    function ut(n, t, e) {
        ...
        return o ? (i = .5 > c ? o / (a + u) : o / (2 - a - u), r = n == a ? (t - e) / o + (e > t ? 6 : 0) : t == a ? (e - n) / o + 2 : (n - t) / o + 4, r*= 60
    ):
        (r = 0 / 0, i = c > 0 && 1 > c ? 0 : r), F(r, i, c)
    }

    function at(n, t, e) {
        n = ot(n), t = ot(t), e = ot(e);
        var r = Q((.4124564 * n + .3575761 * t + .1804375 * e) / Ra), i = Q((.2126729 * n + .7151522 * t + .072175 * e) / Oa), u = Q((.0193339 * n + .119192 * t + .9503041 * e) / Ya);
    ...
    function ht(n, t, e, r) {
        ...
        var u = {}, a = ua.dispatch("progress", "load", "error"), o = {}, c = new (oa.XDomainRequest && /^(http(s)?:)?\/\//.test(n) ? XDomainRequest : XMLHttpRequest);
        ...
        return e.parse = function (n, t) {
            ...
            function e() {
                ...
                .
                    ...
                    10 === r && (i = !0), n.substring(t + 1, e).replace(/""/g, '"')
                }
                for (; c > f;) {
    ...
    function dt() {
        var n = mt(), t = vt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout($a), $a = setTimeout(dt, t)), Ba = 0) : (Ba = 1, Ja
        (dt)
    )
    }
    ...
    function $t(n) {
        ...
        function e(n) {
            ...
            return {
                lineStart: function () {
                    ...
                    if (!e && (l = c = d) && n.lineStart(), d !== c && (g = r(e, p), (zt(e, g) || zt(p, g)) && (p[0] += ja, p[1] += ja, d = t(p[0], p[1]))), d !== c)f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n
                    .
        ...
        function r(n, t, e) {
            var r = Et(n), i = Et(t), a = [1, 0, 0], o = At(r, i), c = kt(o, o), l = o[0], f = c - l * l;
            if (!f)return !e && n;
            var s = u * c / f, h = -u * l / f, g = At(a, o), p = qt(a, s), d = qt(o, h);
            Nt(p, d);
            var m = g, v = kt(p, m), y = kt(m, m), M = v * v - y * (kt(p, p) - 1);
            if (!(0 > M)) {
                var x = Math.sqrt(M), b = qt(m, (-v - x) / y);
        ...
        var u = Math.cos(n), a = u > 0, o = Math.abs(u) > ja, c = oe(n, 6 * La);
        return Ot(t, e, c)
    }
    ...
    function ne(n) {
        ...
        return t.stream = function (n) {
            ...
            return arguments.length ? (f = +n, r()
            ):
            f
        }, t.translate = function (n) {
            return arguments.length ? (s = +n[0], h = +n[1], r()
            ):
            [s, h]
        }, t.center = function (n) {
            return arguments.length ? (g = n[0] % 360 * La, p = n[1] % 360 * La, r()
            ):
            [g * Fa, p * Fa]
        }, t.rotate = function (n) {
            return arguments.length ? (d = n[0] % 360 * La, m = n[1] % 360 * La, v = n.length > 2 ? n[2] % 360 * La : 0, r()
            ):
            [d * Fa, m * Fa, v * Fa]
    ...
    function oe(n, t) {
        ...
        return function (i, u, a, o) {
            null != i ? (i = ce(e, i), u = ce(e, u),(a > 0 ? u > i : i > u) && (i += 2 * a * Da)
            ):
            (i = n + 2 * a * Da, u = n);
    ...
    function ge(n, t, e, r) {
        var i = Math.cos(t), u = Math.sin(t), a = Math.cos(r), o = Math.sin(r), c = i * Math.cos(n), l = i * Math.sin(n), f = a * Math.cos(e), s = a * Math.sin(e), h = 2 * Math.asin(Math.sqrt(V(r - t) + i * a * V(e - n))), g = 1 / Math.sin(h), p = h ? function (n) {
    ...
    function De(n) {
        ...
        var e = je, r = Le, i = Ht, u = Fe, a = u.key, o = .7;
    ...
    function Qe(n) {
        for (var t, e, r, i, u = [], a = We(n), o = -1, c = n.length - 1; ++o < c;)t = Ke(n[o], n[o + 1]), Math.abs(t) < 1e-6 ? a[o] = a[o + 1] = 0 : (e = a[o] / t, r = a[o + 1] / t, i = e * e + r * r, i
    >
        9 && (i = 3 * t / Math.sqrt(i), a[o] = i * e, a[o + 1] = i * r)
    )
        ;
        ...
        var e = {
            ...
            bisect: function (n, t) {
                ...
                if (e.a === 1) {
                    ...
                    if (!i && e.b < 0 || i && e.b >= 0 ? c = o = u >= e.b * a : (c = t.x + t.y * e.b > e.c, e.
                    b < 0 && (c = !c), c || (o = 1)
                ),
                    !o
                )
    ...
    function fr(n) {
        var t = [n.a, n.b], e = [n.c, n.d], r = hr(t), i = sr(t, e), u = hr(gr(e, t, -i)) || 0;
    ...
    function dr(n, t) {
        ...
        return o[0] != c[0] || o[1] != c[1] ? (r.push("translate(", null, ",", null, ")"), i.push({
            ...
            x: pr(s, h)
        }) : h && r.push(r.pop() + "skewX(" + h + ")"), g[0] != p[0] || g[1] != p[1] ? (e = r.push(r.pop() + "scale(", null, ",", null, ")"), i
    .
        push({i: e - 4, x: pr(g[0], p[0])}, {i: e - 2, x: pr(g[1], p[1])})
    ):
    ...
    function vr(n, t) {
        ...
        for (o < t.length && l.push(t.substring(o)), r = 0, u = f.length; (e = Oo.exec(n)) && u > r; ++r)if (a = f[r], a.x == e[0]) {
    ...
    function jr(n, t) {
        ...
        return isNaN(a) && (a = 0, r = isNaN(r) ? t.c : r), isNaN(u) ? (u = 0, e = isNaN(e) ? t.h : e):u
    >
        180 ? u -= 360 : -180 > u && (u += 360), function (n) {
    ...
    function Lr(n, t) {
        ...
        return isNaN(a) && (a = 0, r = isNaN(r) ? t.s : r), isNaN(u) ? (u = 0, e = isNaN(e) ? t.h : e):u
    >
        180 ? u -= 360 : -180 > u && (u += 360), function (n) {
    ...
    function Yi(n, t, e, r) {
        function i() {
            var i = Math.min(n.length, t.length) > 2 ? Oi : Pi, c = r ? Rr : Pr;
        ...
        return u.invert = function (n) {
            ...
            return arguments.length ? (n = t.map(Number), i()
            ):
            n
        }, u.range = function (n) {
            ...
            return arguments.length ? (r = n, i()
            ):
            r
        }, u.interpolate = function (n) {
            return arguments.length ? (e = n, i()
            ):
            e
        }, u.ticks = function (t) {
            return Xi(n, t)
    ...
    function Vi(n, t) {
        var e = Fi(n), r = e[1] - e[0], i = Math.pow(10, Math.floor(Math.log(r / t) / Math.LN10)), u = t / r * i;
    ...
    function Bi(n, t, e, r, i) {
        ...
        return u.invert = function (t) {
            ...
            if (i.every(isFinite)) {
                ...
                if (e === Gi)for (u.push(-Math.pow(t, -o)); o++ < c;)for (var h = s - 1; h > 0; h--)u.push(-Math.pow(t, -o) * h); else {
            ...
            var a, o = Math.log(t), c = Math.max(.1, n / u.ticks().length), l = e === Gi ? (a = -1e-12, Math
            .
            floor
            ):
            (a = 1e-12, Math
    ...
    function Wi(n, t, e) {
        ...
        return r.invert = function (t) {
            ...
            return arguments.length ? (i = Qi(t = a), u = Qi(1 / t), n
            .
            domain(e.map(i)), r
            ):
            t
    ...
    function fu(n) {
        ...
        var e = je, r = je, i = 0, u = Le, a = Ht, o = Fe, c = o.key, l = o, f = "L", s = .7;
        return t.x = function (n) {
    ...
    function Gu(n, t, e) {
        ...
        return r.invert = function (t) {
            ...
            if ("function" != typeof e) {
                var a = u[1] - u[0], o = a / e, c = ua.bisect(Lc, o);
    ...
    function na(n) {
        var t = n.getFullYear(), e = Qu(t), r = Qu(t + 1);
        return t + (n - e) / (r - e)
    }
    ...
    ua.touches = function (n, t) {
        ...
        function t() {
            ...
            function i() {
                o({type: "dragend"}), g && (l(), ua.event.target === c && s(p, "click")), p.on(null != f ? "touchmove.drag-" + f : "mousemove.drag", null).on(null != f ? "touchend.drag-" + f : "mouseup.drag", null)
            }
    ...
    ua.behavior.zoom = function () {
        ...
        function a(n) {
            u(), ua.event.preventDefault(), n({type: "zoom", scale: S, translate: w})
        }
        ...
        return n.translate = function (t) {
            return arguments.length ? (w = t.map(Number), u(), n
            ):
            w
        }, n.scale = function (t) {
            return arguments.length ? (S = +t, u(), n
            ):
            S
    ...
    "onmousewheel"in aa ? (qa = function () {
    ...
    var Pa = 18, Ra = .95047, Oa = 1, Ya = 1.08883, Ua = J.prototype = new L;
    ...
    ua.formatPrefix = function (n, t) {
        ...
        var t = no.exec(n), e = t[1] || " ", r = t[2] || ">", i = t[3] || "", u = t[4] || "", a = t[5], o = +t[6], c = t[7], l = t[8], f = t[9], s = 1, h = "", g = !1;
    ...
    if (Wa) {
        ...
        eo = function (n) {
            ...
            r.push(n.substring(t -= u, t + u)), u = Wa[i = (i + 1) % ro];
    ...
    var ao, oo, co = {
        sphere: function () {
            ao += 4 * Da
        }, point: q, lineStart: q, lineEnd: q, polygonStart: function () {
    ...
    ua.geo.bounds = function () {
        ...
        function t(t, e) {
            var r = Et([t * La, e * La]);
            if (v) {
                var i = At(v, r), u = [i[1], -i[0], 0], a = At(u, i);
                Tt(a), a = Ct(a);
        ...
        var f, s, h, g, p, d, m, v, y, M, x, b = {
            point: n, lineStart: e, lineEnd: r, polygonStart: function () {
                ...
                co.polygonEnd(), b.point = n, b.lineStart = e, b.lineEnd = r, 0 > oo ? (f = -(h = 180), s = -(g = 90)):y
                >
                ja ? g = 90 : -ja > y && (s = -90), x[0] = f, x[1] = h
            }
        };
        return function (n) {
    ...
    var lo, fo, so, ho, go, po = {
        ...
        }, point: Dt, lineStart: Lt, lineEnd: Ft, polygonStart: function () {
    ...
    ua.geo.projection = Qt, ua.geo.projectionMutator = ne, (ua.geo.equirectangular = function () {
        ...
        function n() {
            var n = "function" == typeof r ? r.apply(this, arguments) : r, t = re(-n[0] * La, -n[1] * La, 0).invert, i = [];
        ...
        return n.lines = function () {
            ...
            return arguments.length ? (u = +t[0][0], i = +t[1][0], l = +t[0][1], c = +t[1][1], u
            >
            i && (t = u, u = i, i = t), l > c && (t = l, l = c, c = t), n.precision(y)
            ):
            [[u, l], [i, c]]
        }, n.minorExtent = function (t) {
            return arguments.length ? (r = +t[0][0], e = +t[1][0], o = +t[0][1], a = +t[1][1], r
            >
            e && (t = r, r = e, e = t), o > a && (t = o, o = a, a = t), n.precision(y)
            ):
            [[r, o], [e, a]]
        }, n.step = function (t) {
    ...
    }, Ao = {point: ye, lineStart: q, lineEnd: q, polygonStart: q, polygonEnd: q}, No = {
        point: be,
        lineStart: _e,
        lineEnd: we,
        polygonStart: function () {
    ...
    ua.geo.path = function () {
        ...
        return n.area = function (n) {
            ...
            return So = Eo = -(_o = wo = 1 / 0), ua.geo.stream(n, r(Ao)), [[_o, wo], [So, Eo]]
    ...
    ua.geom.hull = function (n) {
        function t(n) {
            ...
            if (d === je && r === Le)t = n; else for (u = 0, t = []; v > u; ++u)t.push([+d.call(this, i = n[u], u), +m.call(this, i, u)]);
        ...
        function t(n) {
            ...
            if (c === je && l === Le)t = n; else for (t = [], a = 0; f > a; ++a)t.push([+c.call(this, r = n[a], a), +l.call(this, r, a)]);
            if (ir(t, function (n) {
                    var t, e, r, i, u, a;
        ...
        return arguments.length ? t(n) : (t.x = function (n) {
            ...
            if (c === je && l === Le)t = n; else for (r = 0; f > r; ++r)t.push([+c.call(this, e = n[r], r), +l.call(this, e, r)]);
    ...
    ua.geom.quadtree = function (n, t, e, r, i) {
        ...
        var a, o = je, c = Le;
        return (a = arguments.length) ? (o = ur, c = ar,3 === a && (i = e, r = t, e = t = 0), u(n)
        ):
        (u.x = function (n) {
    ...
    var Yo = function () {
        ...
        linear: Yo, poly: Ar, quad: function () {
            return Sr
        }, cubic: function () {
            return Er
        }, sin: function () {
            ...
            return Tr
        }, elastic: Cr, back: zr, bounce: function () {
            return Dr
        }
    }), Io = ua.map({
        "in": ft, out: _r, "in-out": wr, "out-in": function (n) {
            return wr(_r(n))
        }
    });
    ua.ease = function (n) {
    ...
    ua.layout.stack = function () {
        ...
        var t = ft, e = ei, r = ri, i = ti, u = Qr, a = ni;
    ...
    ua.layout.histogram = function () {
        ...
        function n(n, i) {
            ...
            var f = gi(l, di), s = gi(l, pi), h = gi(l, mi), g = f.x - e(f, s) / 2, p = s.x + e(s, f) / 2, d = h.depth || 1;
            return vi(l, function (n) {
                n.x = (n.x - g) / (p - g) * r[0], n.y = n.depth / d * r[1], delete n._tree
            }), c
        }

        var t = ua.layout.hierarchy().sort(null).value(null), e = fi, r = [1, 1];
        ...
        var t = ua.layout.hierarchy().sort(bi), e = 0, r = [1, 1];
        ...
        function n(n, i) {
            ...
            var l = zi(o), f = Di(o), s = l.x - e(l, f) / 2, h = f.x + e(f, l) / 2;
        ...
        return u.size = function (n) {
            ...
            return arguments.length ? (c = n ? Math.round : Number, u):c
            !=
            Number
        }, u.sticky = function (n) {
    ...
    ua.scale.quantile = function () {
        ...
        function n() {
            var n = t.apply(this, arguments), u = e.apply(this, arguments), a = r.apply(this, arguments) + nc, o = i.apply(this, arguments) + nc, c = (a > o && (c = a, a = o, o = c), o - a), l = Da > c ? "0" : "1", f = Math.cos(a), s = Math.sin(a), h = Math.cos(o), g = Math.sin(o);
        ...
        return n.innerRadius = function (e) {
            ...
            var n = (t.apply(this, arguments) + e.apply(this, arguments)) / 2, u = (r.apply(this, arguments) + i.apply(this, arguments)) / 2 + nc;
            return [Math.cos(u) * n, Math.sin(u) * n]
        }, n
    };
    var nc = -Da / 2, tc = 2 * Da - 1e-6;
    ua.svg.line.radial = function () {
        ...
        function t(n, t, e, r) {
            var i = t.call(n, e, r), u = o.call(n, i, r), a = c.call(n, i, r) + nc, f = l.call(n, i, r) + nc;
        ...
        var n = ua.svg.diagonal(), t = hu, e = n.projection;
    ...
    ua.svg.brush = function () {
        ...
        function i() {
            ...
            function p(n, t, e) {
                ...
                return E && (o -= l, c -= f + l), r = Math.max(o, Math.min(c, n[e])), E ? i = (r += l) + f : (m && (l = Math.max(o, Math.min(c, 2 * m[e] - r))), r > l ? (i = r, r = l):i= l), s[0][e] !== r || s[1][e] !== i ? (u = null, s[0][e] = r, s[1][e] = i, !0
            ):
                void 0
            }

            function d() {
                g(), b.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), ua.select("body").style("cursor", null), A.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), x({type: "brushend"}), l()
            }
        ...
        return n.x = function (t) {
            ...
            var e, r, i, a, l;
            return arguments.length ? (u = [[0, 0], [0, 0]], o
            &&
            (e = t[0], r = t[1], c
            &&
            (e = e[0], r = r[0]), u[0][0] = e, u[1][0] = r, o.invert && (e = o(e), r = o(r)), e > r && (l = e, e = r, r = l), s[0][0] = 0 | e, s[1][0] = 0 | r
            ),
            c && (i = t[0], a = t[1], o && (i = i[1], a = a[1]), u[0][1] = i, u[1][1] = a, c.invert && (i = c(i), a = c(a)), i > a && (l = i, i = a, a = l), s[0][1] = 0 | i, s[1][1] = 0 | a), n
            ):
            (t = u || s, o
            &&
            (e = t[0][0], r = t[1][0], u
            ...
            (e = s[0][0], r = s[1][0], o
            .
            invert && (e = o.invert(e), r = o.invert(r)), e > r && (l = e, e = r, r = l)
            )),
            c && (i = t[0][1], a = t[1][1], u || (i = s[0][1], a = s[1][1], c.invert && (i = c.invert(i), a = c.invert(a)), i > a && (l = i, i = a, a = l))), o && c ? [[e, i], [r, a]] : o ? [e, r] : c && [i, a]
            )
        }, n.clear = function () {
    ...
    ua.time.year = Eu(function (n) {
        ...
        return t.parse = function (t) {
            var e = {y: 1900, m: 0, d: 1, H: 0, M: 0, S: 0, L: 0}, r = Au(e, n, t, 0);
    ...
    var wc = Nu(Mc), Sc = Nu(xc), Ec = Nu(bc), kc = qu(bc), Ac = Nu(_c), Nc = qu(_c), qc = {
        "-": "",
        _: " ",
        0: "0"
    }, Tc = {
        ...
        }, c: ua.time.format(mc), d: function (n, t) {
        ...
        }, x: ua.time.format(vc), X: ua.time.format(yc), y: function (n, t) {
