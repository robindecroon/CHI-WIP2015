...
fout.write("name,cholesterol,inkomen,#sigaretten,alcohol,systolische bloeddruk,diastolische bloeddruk,gewicht,glycemie,leeftijd,lat,lng,geslacht,icpc,count,#dagen sinds laatste bezoek\n")
for num in range(1,100):
	...
	printline = patient_name + "," + str(cholesterol) + "," + str(income) + "," + str(sigarets) + "," + str(alcohol) + ","+ str(blood_pressure_high) + "," + str(blood_pressure_low) + "," + str(weight) + "," +str(sugar) + "," + str(age) + "," + str(lat) + "," + str(lng) + "," +  gender + "," + icpc +",1," + str(days_since_last_visit) + '\n'
