...
fout.write("name,id,foto,selected,hoofddokter,cholesterol,diploma,religie,inkomen,#sigaretten,alcohol,systolische bloeddruk,diastolische bloeddruk,gewicht,glycemie,leeftijd,lat,lng,geslacht,icpc,count,#dagen sinds bezoek\n")
for num in range(1,95):
	...
	printline = patient_name + "," + str(index) +",null,false," + str(headPhysician) + "," + str(cholesterol) + "," + str(degree) + "," + str(religion) + "," + str(income) + "," + str(sigarets) + "," + str(alcohol) + ","+ str(blood_pressure_high) + "," + str(blood_pressure_low) + "," + str(weight) + "," +str(sugar) + "," + str(age) + "," + str(lat) + "," + str(lng) + "," +  gender + "," + icpc +",1," + str(days_since_last_visit) + '\n'
	index = index + 1
